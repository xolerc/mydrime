...
(function () {
  ...
  const FRAG = [
    ...
    '',
    '  vec3 darkSteel  = vec3(0.005, 0.005, 0.005);',
    '  vec3 midChrome  = vec3(0.07, 0.07, 0.07);',
    '  vec3 pureSilver = vec3(0.2, 0.2, 0.2);',
    '  vec3 whiteGlow  = vec3(0.32, 0.32, 0.32);',
    ...
    '  vec3 seaA = vec3(0.04, 0.04, 0.04);',
    '  vec3 seaB = vec3(0.1, 0.1, 0.1);',
    ...
    '  color += vec3(0.25, 0.25, 0.25) * glow * 0.16;',
    '  color += seaB * glow * 0.1;',
