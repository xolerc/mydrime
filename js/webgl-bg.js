...
(function () {
  ...
  const FRAG = [
    ...
    '',
    '  vec3 darkSteel  = vec3(0.02, 0.02, 0.02);',
    '  vec3 midChrome  = vec3(0.30, 0.30, 0.30);',
    '  vec3 pureSilver = vec3(0.82, 0.82, 0.82);',
    '  vec3 whiteGlow  = vec3(0.98, 0.98, 0.98);',
    ...
    '  vec3 seaA = vec3(0.16, 0.16, 0.16);',
    '  vec3 seaB = vec3(0.34, 0.34, 0.34);',
    ...
    '  color += vec3(0.85, 0.85, 0.85) * glow * 0.16;',
    '  color += seaB * glow * 0.1;',
    '',
    '  color += vec3(spec * 0.3);',
    '',
