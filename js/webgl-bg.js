...
(function () {
  ...
  const FRAG = [
    ...
    '',
    '  vec3 darkSteel  = vec3(0.01, 0.01, 0.01);',
    '  vec3 midChrome  = vec3(0.16, 0.16, 0.16);',
    '  vec3 pureSilver = vec3(0.42, 0.42, 0.42);',
    '  vec3 whiteGlow  = vec3(0.65, 0.65, 0.65);',
    ...
    '  vec3 seaA = vec3(0.08, 0.08, 0.08);',
    '  vec3 seaB = vec3(0.18, 0.18, 0.18);',
    ...
    '  color += vec3(0.45, 0.45, 0.45) * glow * 0.16;',
    '  color += seaB * glow * 0.1;',
    '',
    '  color += vec3(spec * 0.3);',
    '',
