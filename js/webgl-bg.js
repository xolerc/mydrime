...
(function () {
  ...
  const FRAG = [
    ...
    '',
    '  // VISIBLY liquid: previous stops (0.002–0.16) rendered so close to',
    '  // pure black that a running shader was indistinguishable from off.',
    '  // These stops keep the dark theme but read clearly as moving metal.',
    '  vec3 darkSteel  = vec3(0.020, 0.024, 0.032);',
    '  vec3 midChrome  = vec3(0.100, 0.110, 0.130);',
    '  vec3 pureSilver = vec3(0.300, 0.330, 0.400);',
    '  vec3 whiteGlow  = vec3(0.550, 0.580, 0.660);',
    ...
    '  vec3 seaA = vec3(0.015, 0.017, 0.022);',
    '  vec3 seaB = vec3(0.050, 0.055, 0.065);',
